...
class CustomerServiceTest {
    ...
    void testGetCustomer_whenNormalCase_returnCustomerVm() {
        ...
        CustomerVm customerVm = new CustomerVm("user1", "user@example.com", "Cuong", "Tran");
        ...
        assertThat(result.firstName()).isEqualTo("Cuong");
    }

    @Test
    void testHandleFallback_whenNewThrowable_returnNull() throws Throwable {
